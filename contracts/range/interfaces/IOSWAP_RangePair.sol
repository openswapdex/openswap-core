...
interface IOSWAP_RangePair is IOSWAP_PausablePair {
    ...
    event AddLiquidity(address indexed provider, bool indexed direction, uint256 staked, uint256 amount, uint256 lowerLimit, uint256 upperLimit, uint256 newStakeBalance, uint256 newAmountBalance, uint256 startDate, uint256 expire);
    ...
    event RemoveLiquidity(address indexed provider, bool indexed direction, uint256 unstake, uint256 amountOut, uint256 reserveOut, uint256 lowerLimit, uint256 upperLimit, uint256 newStakeBalance, uint256 newAmountBalance, uint256 newReserveBalance, uint256 startDate, uint256 expire);
    ...
    event SwappedOneProvider(address indexed provider, bool indexed direction, uint256 amountOut, uint256 amountIn, uint256 newAmountBalance, uint256 newReserveBalance);
